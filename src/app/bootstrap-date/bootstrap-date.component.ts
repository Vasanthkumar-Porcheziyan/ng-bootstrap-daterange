...
@Component({
  selector: 'app-bootstrap-date',
  templateUrl: './bootstrap-date.component.html',
  styleUrls: ['./bootstrap-date.component.scss']
})
export class BootstrapDateComponent implements OnInit {
